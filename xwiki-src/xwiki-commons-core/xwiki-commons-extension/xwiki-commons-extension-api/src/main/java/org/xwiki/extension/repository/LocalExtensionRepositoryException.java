...
/**
 * {@link LocalExtensionRepository} related error.
 *
 * @version $Id: c198065a0e8cf2d8aa567aec8bf5f1c3c41fd888 $
 * @since 4.0M1
 */
public class LocalExtensionRepositoryException extends ExtensionRepositoryException
{
     ...
     */
    public LocalExtensionRepositoryException(String message)
    {
        super(message);
    }
     ...
     */
    public LocalExtensionRepositoryException(String message, Throwable cause)
    {
        super(message, cause);
    }
}
