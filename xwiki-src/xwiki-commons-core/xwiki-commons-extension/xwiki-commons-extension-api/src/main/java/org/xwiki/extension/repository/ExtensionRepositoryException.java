 ...
 *
 * @version $Id: ed17852881cafb629ff1b4cc7120e40e2d931ef8 $
 * @since 4.0M1
 */
public class ExtensionRepositoryException extends ExtensionException
{
     ...
     */
    public ExtensionRepositoryException(String message)
    {
        super(message);
    }
     ...
     */
    public ExtensionRepositoryException(String message, Throwable cause)
    {
        super(message, cause);
    }
}
