 ...
 * @version $Id: 232e309d3f3e7a5dc3402859a535b803e1b67466 $
 * @since 7.4M1
 */
...
public abstract class AbstractJob<R extends Request, S extends JobStatus> implements Job
{
    ...
    protected S createNewStatus(R request)
    {
        ...
        return (S) new DefaultJobStatus<R>(request, currentJobStatus, this.observationManager, this.loggerManager);
    }
