...
/**
 * Abstract base class for a asymmetric cipher factory using an OAEP padding scheme.
 *
 * @version $Id: f33b16f4d82a7e2d1624dd519bb027599538bc88 $
 * @since 5.4M1
 */
public abstract class AbstractBcOAEPEncodedCipherFactory extends AbstractBcAsymmetricCipherFactory
{
    @Override
    protected AsymmetricBlockCipher getCipherInstance(boolean forEncryption, AsymmetricCipherParameters parameters)
    {
