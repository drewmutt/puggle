...
/**
 * Implement PBES2 encryption scheme with DES encryption.
 *
 * @version $Id: 905e6a98f331b8944493171c9360c7b4a8fb9c51 $
 * @since 5.4M1
 */
@Component(hints = { "PBES2-DES-Pad", "1.3.14.3.2.7" })
@Singleton
public class BcPBES2DesCipherFactory extends AbstractBcPBES2CipherFactory
{
    private static final ASN1ObjectIdentifier ALG_ID = new ASN1ObjectIdentifier("1.3.14.3.2.7");

    @Inject
    @Named("DES/CBC/PKCS5Padding")
