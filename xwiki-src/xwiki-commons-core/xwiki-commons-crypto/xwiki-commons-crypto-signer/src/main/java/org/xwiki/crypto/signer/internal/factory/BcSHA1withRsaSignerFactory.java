 ...
 *
 * @version $Id: d8c4b2f59bbfaef9e7d21c3c335991f7f9fe452f $
 * @since 5.4RC1
 */
@Component(hints = { "SHA1withRSAEncryption", "1.2.840.113549.1.1.5" })
@Singleton
public class BcSHA1withRsaSignerFactory extends AbstractBcSignerFactory
{
